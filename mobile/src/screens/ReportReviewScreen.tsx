...
const styles = StyleSheet.create({
  ...
  pageTitle: { color: '#F2F3F5', fontSize: 36 / 2, fontWeight: '800' },
  card: {
  ...
  label: { fontSize: 28 / 2, fontWeight: '800', color: '#F2F3F5' },
  photoBox: { width: '100%', aspectRatio: 4 / 3, backgroundColor: '#111', borderRadius: 8, overflow: 'hidden' },
  mapArea: { backgroundColor: '#1a1d22', borderRadius: 10, height: 190, overflow: 'hidden' },
  dragLabel: {
    position: 'absolute',
    left: 10,
    top: 10,
  ...
  pinText: { fontSize: 32 },
  address: { fontSize: 32 / 2, fontWeight: '600', color: '#8D939E' },
  selector: {
    borderRadius: 8,
  ...
  selectorText: { fontSize: 34 / 2, color: '#F2F3F5', fontWeight: '700' },
  selectorIcon: { fontSize: 28 / 2, color: '#8D939E', fontWeight: '700' },
  ...
  secondaryButtonText: { fontWeight: '700', color: '#F2F3F5' },
  submitButton: {
    margin: 14,
    borderRadius: 14,
